...
- [gd::stack::vector](#stack-vector) – Small Vector Optimization with Zero-Heap Performance
- [gd::borrow::vector](#borrow-vector) – Zero-Heap Performance with External Storage

---

<a name="stack-vector"></a>
