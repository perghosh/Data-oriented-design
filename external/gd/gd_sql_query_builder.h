 ...
 * 
 * A proxy object that allows chaining of method calls to set field attributes and specify the SQL query part it belongs to.
 */
...
/// global operator to add field builder to query: query << field_g("name").as("alias").orderby();
