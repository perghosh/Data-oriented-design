...
*///@{
   ...
   std::pair<bool, std::string> FILE_UpdatePatternLog(const std::vector<std::string>& vectorPattern, const gd::argument::shared::arguments& argumentsList, int iThreadCount = 0);
