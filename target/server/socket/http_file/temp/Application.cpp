...
boost::beast::http::message_generator handle_request( boost::beast::string_view doc_root, boost::beast::http::request<Body, boost::beast::http::basic_fields<Allocator>>&& req)
{
   ...
   auto const bad_request =
      ...
      {
         boost::beast::http::response<http::string_body> res{http::status::bad_request, req.version()};
   ...
   auto const not_found =
      ...
      {
         boost::beast::http::response<http::string_body> res{http::status::not_found, req.version()};
         res.set(http::field::server, BOOST_BEAST_VERSION_STRING);
         res.set(http::field::content_type, "text/html");
         res.keep_alive(req.keep_alive());
   ...
   auto const server_error =
      ...
      {
         boost::beast::http::response<http::string_body> res{http::status::internal_server_error, req.version()};
         res.set(http::field::server, BOOST_BEAST_VERSION_STRING);
         res.set(http::field::content_type, "text/html");
         res.keep_alive(req.keep_alive());
   ...
   boost::beast::http::response<http::file_body> res{
