...
std::pair<bool, std::string> LuaSSRExecute(std::string_view stringScript, CAPIContext* pcontext_, CRENDERSql* psql, std::string* pstringSSRPage, callback_lua_state callback_ = nullptr);
